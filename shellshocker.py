...
def main():
	try:
		...
		print e
		print "\nUsing ERROR:\nCan be used with proxy, Syntax: python - target - proxy\nExample:\t'python shellshocker.py http://example.com/cgi-bin/cat 192.168.1.5:3128'\nExample 2:\t'python shellshocker.py http://example.com/cgi-bin/cat'\n"
